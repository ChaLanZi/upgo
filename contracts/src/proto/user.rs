...
pub struct SubmitKycRequest {
    ...
    pub id_photo_front: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "5")]
    pub id_photo_back: ::prost::alloc::vec::Vec<u8>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "GetProfile"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "UpdateProfile"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn approve_kyc(
            &mut self,
            request: impl tonic::IntoRequest<super::ApproveKycRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ApproveKycResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/user.UserService/ApproveKyc",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "ApproveKyc"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn reject_kyc(
            &mut self,
            request: impl tonic::IntoRequest<super::RejectKycRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RejectKycResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/user.UserService/RejectKyc",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user.UserService", "RejectKyc"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod user_service_server {
    ...
    pub trait UserService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn approve_kyc(
            &self,
            request: tonic::Request<super::ApproveKycRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ApproveKycResponse>,
            tonic::Status,
        >;
        async fn reject_kyc(
            &self,
            request: tonic::Request<super::RejectKycRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RejectKycResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/user.UserService/ApproveKyc" => {
                    #[allow(non_camel_case_types)]
                    struct ApproveKycSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::ApproveKycRequest>
                    for ApproveKycSvc<T> {
                        type Response = super::ApproveKycResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::approve_kyc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ApproveKycSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/user.UserService/RejectKyc" => {
                    #[allow(non_camel_case_types)]
                    struct RejectKycSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::RejectKycRequest>
                    for RejectKycSvc<T> {
                        type Response = super::RejectKycResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::reject_kyc(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
